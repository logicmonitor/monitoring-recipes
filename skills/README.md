...
| Skill | Description |
|-------|-------------|
| [logicmonitor-authoring](logicmonitor-authoring/) | End-to-end LogicModule authoring workflow with script structure standards and snippet-first recipes (v0.4.0) |
